...
let content = fs.readFileSync('data/research.json', 'utf8');
...
const newNote = {
    ...
    "tags": ["minecraft", "map-artists", "sourcing", "ice-dragon", "contact-info", "action-items"],
    ...
    "sourceUrls": ["https://www.upwork.com", "https://www.mc-market.org", "https://www.planetminecraft.com", "https://www.reddit.com/r/MinecraftBuilds"],
...
// Write back
fs.writeFileSync('data/research.json', JSON.stringify(data, null, 2));

console.log(`SUCCESS: Added note-022. Total notes: ${data.notes.length}`);

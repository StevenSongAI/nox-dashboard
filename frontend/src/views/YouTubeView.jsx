...
const typeFilters = [
  ...
  { value: 'content_brief', label: 'Briefs' },
...
function YouTubeView() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h2 className="text-3xl font-bold mb-2">YouTube</h2>
        <p className="text-gray-400">
          {pagination.total} entries • Outliers, competitors, and research
        </p>
      </div>
      ...
      <div className="mb-6">
        <SearchBar
          ...
          placeholder="Search videos, channels, research..."
        />
      </div>
